local function setup_gitsigns()
	require("gitsigns").setup({
		on_attach = function(_)
			...
			keymap.map(keymap.normalMode, keymap.leader .. "hS", gitsigns.stage_buffer, { desc = "Git stage buffer" })
			keymap.map(keymap.normalMode, keymap.leader .. "hR", gitsigns.reset_buffer, { desc = "Git reset buffer" })
			keymap.map(keymap.normalMode, keymap.leader .. "hp", gitsigns.preview_hunk, { desc = "Git preview hunk" })
			keymap.map(
				keymap.normalMode,
				keymap.leader .. "hi",
