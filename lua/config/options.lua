...
vim.opt.number = true -- enable display line numbers
vim.opt.numberwidth = 2 -- set width of line number column (smaller than default)
vim.opt.signcolumn = "yes" -- always show sign column
vim.opt.wrap = false -- display lines as single line (add to command to change it)
